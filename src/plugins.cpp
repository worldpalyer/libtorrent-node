...
void bootstrap(const FunctionCallbackInfo<Value>& args) {
    ...
    // enable_natpmp->BooleanValue()); params.settings.set_bool(settings_pack::enable_lsd, enable_lsd->IsBoolean() &&
    // enable_lsd->BooleanValue()); params.settings.set_bool(settings_pack::enable_dht, enable_dht->IsBoolean() &&
